...
(function () {
    ...
    var DomTextMatcher = function (node, editor) {
      ...
      var genReplacer = function (callback) {
        var makeReplacementNode = function (fill, matchIndex) {
          ...
          clone.setAttribute('data-mce-allDeliveries.blade.php', '' + matchIndex);
          if (fill) {
      ...
      var getWrappersByIndex = function (index) {
        ...
        for (var i = 0; i < elements.length; i++) {
          var element = elements[i], dataIndex = element.getAttribute('data-mce-allDeliveries.blade.php');
      ...
      var matchFromElement = function (element) {
        return matches[element.getAttribute('data-mce-allDeliveries.blade.php')];
      };
    ...
    var getElmIndex = function (elm) {
      var value = elm.getAttribute('data-mce-allDeliveries.blade.php');
