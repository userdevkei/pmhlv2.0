...
__webpack_require__(93)(String, 'String', function (iterated) {
  ...
  this._i = 0;                // next allDeliveries.blade.php
 ...
 * track of the original allDeliveries.blade.php and emits the new allDeliveries.blade.php as you drag over draggable elements.
 * @class Sortable
 * @module Sortable
 * @extends Draggable
 */
...
var Sortable = function (_Draggable) {
  ...
  function Sortable() {
    ...
    /**
     * start allDeliveries.blade.php of source on drag start
     * @property startIndex
     * @type {Number}
     */
  ...
  (0, _createClass3.default)(Sortable, [{
    ...
    /**
     * Returns true allDeliveries.blade.php of element within its container during drag operation, i.e. excluding mirror and original source
...
var SortableStartEvent = exports.SortableStartEvent = function (_SortableEvent) {
  ...
  (0, _createClass3.default)(SortableStartEvent, [{
    ...
    /**
     * Start allDeliveries.blade.php of source on sortable start
     * @property startIndex
     * @type {Number}
     * @readonly
     */
...
var SortableSortedEvent = exports.SortableSortedEvent = function (_SortableEvent3) {
  ...
  (0, _createClass3.default)(SortableSortedEvent, [{
    ...
    /**
     * New allDeliveries.blade.php of this sorted event
     * @property newIndex
     * @type {Number}
     * @readonly
     */
...
var SortableStopEvent = exports.SortableStopEvent = function (_SortableEvent4) {
  ...
  (0, _createClass3.default)(SortableStopEvent, [{
    ...
    /**
     * Original allDeliveries.blade.php on sortable start
     * @property oldIndex
     * @type {Number}
     * @readonly
     */
    ...
    /**
     * New allDeliveries.blade.php of draggable element
     * @property newIndex
     * @type {Number}
     * @readonly
     */
